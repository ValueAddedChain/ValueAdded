...
#include <valueAdd/nodestore/impl/ManagerImp.h>
#include <valueAdd/nodestore/impl/DatabaseRotatingImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your valueAdded.cfg is missing a [node_db] entry, "
        "please see the valueAdded-example.cfg file!"
        );
}
