...
#ifndef VALUEADD_NET_RPCCALL_H_INCLUDED
#define VALUEADD_NET_RPCCALL_H_INCLUDED
...
/** Given a valueAdded command line, return the corresponding JSON.
*/
Json::Value
