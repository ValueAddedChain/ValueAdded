...
#ifndef VALUEADD_SERVER_SSLHTTPPEER_H_INCLUDED
#define VALUEADD_SERVER_SSLHTTPPEER_H_INCLUDED

#include <valueAdd/server/impl/BaseHTTPPeer.h>
#include <valueAdd/server/impl/SSLWSPeer.h>
