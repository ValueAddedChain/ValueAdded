...
#ifndef VALUEADD_SERVER_SERVERIMPL_H_INCLUDED
#define VALUEADD_SERVER_SERVERIMPL_H_INCLUDED

#include <valueAdd/basics/chrono.h>
#include <valueAdd/server/Server.h>
#include <valueAdd/server/impl/Door.h>
