...
#ifndef VALUEADD_PROTOCOL_STACCOUNT_H_INCLUDED
#define VALUEADD_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a valueAdd::uint160.  However, so the serialized format of the
