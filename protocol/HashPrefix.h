...
#ifndef VALUEADD_PROTOCOL_HASHPREFIX_H_INCLUDED
#define VALUEADD_PROTOCOL_HASHPREFIX_H_INCLUDED

#include <valueAdd/beast/hash/hash_append.h>
#include <cstdint>
...
/** Prefix for hashing functions.
    ...
    @note Hash prefixes are part of the valueAdd protocol.
