...
#ifndef VALUEADD_PROTOCOL_QUALITY_H_INCLUDED
#define VALUEADD_PROTOCOL_QUALITY_H_INCLUDED

#include <valueAdd/protocol/AmountConversions.h>
...
// valueAdd specific constant used for parsing qualities and other things
