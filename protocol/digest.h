...
#include <valueAdd/beast/crypto/sha2.h>
#include <valueAdd/beast/hash/endian.h>
#include <algorithm>
#include <array>

namespace valueAdd {

/*  Message digest functions used in the valueAdd Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a valueAdd account, from a message. Typically the
