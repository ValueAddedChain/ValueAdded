...
/*
    ...
    Copyright (c) 2014 valueAdd Labs Inc.
...
#ifndef VALUEADD_PROTOCOL_UINTTYPES_H_INCLUDED
#define VALUEADD_PROTOCOL_UINTTYPES_H_INCLUDED

#include <valueAdd/basics/UnorderedContainers.h>
#include <valueAdd/basics/base_uint.h>
#include <valueAdd/protocol/AccountID.h>
...
template <>
struct hash <valueAdd::Currency> : valueAdd::Currency::hasher
{
};

template <>
struct hash <valueAdd::NodeID> : valueAdd::NodeID::hasher
{
};

template <>
struct hash <valueAdd::Directory> : valueAdd::Directory::hasher
{
};
