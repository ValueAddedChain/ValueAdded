...
#ifndef VALUEADD_PROTOCOL_ACCOUNTID_H_INCLUDED
#define VALUEADD_PROTOCOL_ACCOUNTID_H_INCLUDED

#include <valueAdd/protocol/tokens.h>
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, valueAdded should
...
public:
    ...
    /** Return valueAdd::toBase58 for the AccountID
...
template <>
struct hash <valueAdd::AccountID> : valueAdd::AccountID::hasher
{
};
