...
#include <valueAdd/protocol/Indexes.h>
#include <cassert>
...
{
    return getVacStateIndex (a, issue.account, issue.currency);
}
...
{
    return { ltVAC_STATE,
        getVacStateIndex(id0, id1, currency) };
}
