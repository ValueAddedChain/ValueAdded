...
template <>
struct hash <valueAdd::error_code_i>
{
    std::size_t operator() (valueAdd::error_code_i value) const
    {
        return value;
    }
};
...
public:
        ...
        : m_unknown (rpcUNKNOWN, "unknown", "An unknown error code.")
    {
        ...
        add (rpcNO_NETWORK,            "noNetwork",         "Not synced to valueAdd network.");
        add (rpcNO_PATH,               "noPath",            "Unable to find a valueAdd path.");
