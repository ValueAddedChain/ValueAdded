...
transResults()
{
    ...
    results
    {
        ...
        { temBAD_SEND_XRP_NO_DIRECT, { "temBAD_SEND_XRP_NO_DIRECT","Malformed: No valueAdd direct is not allowed for XRP to XRP."                    } },
        ...
        { temVAC_EMPTY,           { "temVAC_EMPTY",          "PathSet with no paths."                                                        } },
        ...
        { terNO_VAC,              { "terNO_VAC",             "Path does not permit rippling."                                                } },
