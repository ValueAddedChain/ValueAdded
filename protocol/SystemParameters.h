...
#ifndef VALUEADD_PROTOCOL_SYSTEMPARAMETERS_H_INCLUDED
#define VALUEADD_PROTOCOL_SYSTEMPARAMETERS_H_INCLUDED
...
systemName ()
{
    static std::string const name = "valueAdd";
    return name;
}
...
static
std::uint64_t const
SYSTEM_CURRENCY_USERS = 10000000;
...
systemCurrencyCode ()
{
    static std::string const code = "valueAdd";
    return code;
}
