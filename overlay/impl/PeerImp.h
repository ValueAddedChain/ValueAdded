...
#ifndef VAC_OVERLAY_PEERIMP_H_INCLUDED
#define VAC_OVERLAY_PEERIMP_H_INCLUDED

#include <valueAdd/app/consensus/RCLCxPeerPos.h>
#include <valueAdd/basics/Log.h>
#include <valueAdd/beast/core/ByteOrder.h>
#include <valueAdd/beast/utility/WrappedSink.h>
#include <valueAdd/overlay/impl/ProtocolMessage.h>
#include <valueAdd/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the valueAdd protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of valueAdded that the peer is running, if reported. */
    std::string
    getVersion() const;
