...
#include <valueAdd/basics/make_SSLContext.h>
#include <valueAdd/beast/core/LexicalCast.h>
#include <valueAdd/core/DatabaseCon.h>
#include <valueAdd/overlay/Cluster.h>
#include <valueAdd/overlay/predicates.h>
#include <valueAdd/overlay/impl/ConnectAttempt.h>
#include <valueAdd/overlay/impl/PeerImp.h>
#include <valueAdd/peerfinder/make_Manager.h>
#include <valueAdd/rpc/json_body.h>
#include <valueAdd/server/SimpleWriter.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("r.valueAdd.com 51235");
    ...
    // Add the ips_fixed from the valueAdded.cfg file
...
/** The number of active peers on the network
    ...
    and are running the valueAdd protocol.
*/
std::size_t
OverlayImpl::size()
{
