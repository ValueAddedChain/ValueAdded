...
#include <valueAdd/overlay/impl/PeerImp.h>
#include <valueAdd/overlay/impl/Tuning.h>
...
#include <valueAdd/app/misc/Transaction.h>
#include <valueAdd/app/misc/ValidatorList.h>
#include <valueAdd/app/tx/apply.h>
#include <valueAdd/basics/random.h>
#include <valueAdd/basics/UptimeTimer.h>
#include <valueAdd/beast/core/SemanticVersion.h>
...
PeerImp::run()
{
    ...
    {
        auto s = getVersion();
        if (boost::starts_with(s, "valueAdded-"))
        {
