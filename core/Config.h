...
#ifndef VALUEADD_CORE_CONFIG_H_INCLUDED
#define VALUEADD_CORE_CONFIG_H_INCLUDED

#include <valueAdd/basics/BasicConfig.h>
#include <valueAdd/basics/base_uint.h>
#include <valueAdd/protocol/SystemParameters.h> // VFALCO Breaks levelization
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from valueAdded.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from valueAdded.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from valueAdded.cfg.
