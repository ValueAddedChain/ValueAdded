...
#include <valueAdd/protocol/digest.h>
#include <valueAdd/app/main/Application.h>
#include <valueAdd/basics/CheckLibraryVersions.h>
#include <valueAdd/basics/contract.h>
#include <valueAdd/basics/StringUtilities.h>
#include <valueAdd/basics/Sustain.h>
#include <valueAdd/core/Config.h>
#include <valueAdd/core/ConfigSections.h>
#include <valueAdd/core/TerminateHandler.h>
#include <valueAdd/core/TimeKeeper.h>
#include <valueAdd/crypto/csprng.h>
#include <valueAdd/json/to_string.h>
#include <valueAdd/net/RPCCall.h>
#include <valueAdd/resource/Fees.h>
#include <valueAdd/rpc/RPCHandler.h>
#include <valueAdd/protocol/BuildInfo.h>
#include <valueAdd/beast/clock/basic_seconds_clock.h>
#include <valueAdd/beast/core/CurrentThreadName.h>
#include <valueAdd/beast/core/Time.h>
#include <valueAdd/beast/utility/Debug.h>
...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("valueAdded: main");
    ...
    {
        std::cerr << "valueAdded: Incorrect command line syntax." << std::endl;
    ...
    beast::setCurrentThreadName ("valueAdded: rpc");
...
int main (int argc, char** argv)
{
...
#ifdef _MSC_VER
    valueAdd::sha512_deprecatedMSVCWorkaround();
#endif
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile valueAdded.");
#endif

    static_assert (BOOST_VERSION >= 105700,
        "Boost version 1.57 or later is required to compile valueAdded");
    ...
    std::set_terminate(valueAdd::terminateHandler);

    auto const result (valueAdd::run (argc, argv));
